                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="dropdown dropdown-submenu">
                        ...
                        <ul className="dropdown-menu">
                          <li>
                            <Link
                              href="/assers/Our-Deluxe-ERP-Module.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Auto-Alias-Part-Number-Creation-Module.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Auto-Batch-No-Creation-Module-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/delete-master-module-by-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Enhanced-Customized-Reporting-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/ERP-reporting-Module-by-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Label-Printing-module-by-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Month-wise-outstanding-module-by-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Multiple-Email-Setting-by-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Party-wise-Item-Discount-module-by-Glowips.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Purchase-Requisition-Use-Module.pdf"
                              target="_blank"
                            >
                          ...
                          <li>
                            <Link
                              href="/assers/Voucher-Approval-Module-by-glowips.pdf"
                              target="_blank"
                            >
                ...
                <ul className="list-unstyled">
                  <li className="dropdown dropdown-submenu">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <Link
                          href="/assers/Jeweler-Shop-Customization.pdf"
                          target="_blank"
                        >
                          Jewellery Industry
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/GLOWIPS-MANUFACTURING-MODULE-PYARELAL-MODULE-WISE-PROJECT.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/electronic-showroom-module-by-GLowips.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/Hotel-Restaurant-Module-for-Glowips.pdf"
                          target="_blank"
                        >
                          Hotel &amp; Restaurant
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/School-and-college-accounts-management-by-Glowips.pdf"
                          target="_blank"
                        >
                          School &amp; College
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/Training-institute-Module-by-Glowips.pdf"
                          target="_blank"
                        >
                          Training Institute
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/Chit-Fund-Module.pdf"
                          target="_blank"
                        >
                          Chit Fund Module
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/AUTOMOBILE-Module-Compatibility-Mode.pdf"
                          target="_blank"
                        >
                          Automobile Module
                        </Link>
                      ...
                      <li>
                        <Link href="/assers/CRM-Module.pdf" target="_blank">
                          CRM Module
                        </Link>
                      </li>
                      <li>
                        <Link
                          href="/assers/ERP-Manufacturing-MOdule-Part-1.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/ERP-BUS-Module-for-Schools-College-Compatibility-Mode.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/Builders-PropertyDevelopers-module-for-GLOWIPS.pdf"
                          target="_blank"
                        >
                          Builders &amp; Property
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/Tally-ERP-for-Advt.pdf"
                          target="_blank"
                        >
                  ...
                  <li className="dropdown dropdown-submenu">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li>
                        <Link href="/solutions/readyinvoicecust/trading">
                          Trading Invoice
                        </Link>
                      </li>
                      <li>
                  ...
                  <li className="dropdown dropdown-submenu">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <Link
                          href="/assers/GARMENT-INDUSTRY-MODULE.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/Vehicle-Sales-Module.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/PARTY-WISE-OUTSTANDING-MODULE.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/STANDARD-TERMS-AND-CONDITION-MODULE.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="/assers/THREE-DISCOUNT-COLOUM-MODULE.pdf"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link href="/assers/AUTO-PHYSICAL-STOCK-VERIFICATION-MODULE.pdf">
                  ...
                  <li className="dropdown dropdown-submenu">
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <Link
                          href="/assers/GPS-Integration-Compatibility-Mode.pdf"
                          target="_blank"
                        >
                          GPS Integration
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/Hypper-Market-Compatibility-Mode.pdf"
                          target="_blank"
                        >
                          Hyper Market
                        </Link>
                      ...
                      <li>
                        <Link
                          href="/assers/Remote-Location-Barcode-Scanner-Integration-Compatibility-Mode.pdf"
                          target="_blank"
                        >
